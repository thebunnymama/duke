 ...
 */
public class AddEventCmd extends AddTaskCommand {
    ...
    public Message execute() {
        ...
        if (parts.length < 2 ||
            ...
            return new ErrorMessage("Invalid format. Event requires: <description> /from <start to end>");
        }
        ...
        return new AddTaskMessage(event, taskManager);
    }
}
