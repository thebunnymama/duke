...
public class ErrorMessage implements Message {
    ...
    public static final String MISSING_TASK_NUMBER = "You need to tell me the task number, don't make mee guess like buying 4D!\nType 'list' to see your tasks, then use the number.";
